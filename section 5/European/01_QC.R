...
pop_want_European <- pop_want %>% filter(f.21000.0.0 == 4002)
...
# self_European_filtered_data.king.cutoff.out.id , and 3182 remaining sample IDs
...
PC_data_full$Ancestry <- ifelse(is.na(PC_data_full$asthma), "Other", "European (Self-Reported)")
...
ggsave(filename = "/home/ziang/Documents/Stats-Gene/UKB/European_GWAS_hypertension_bp/figures/All_PC_Figure12.pdf", device = "pdf")
PC_data_full %>% ggplot() + geom_point(aes(x = PC3, y = PC4, color = Ancestry, shape = Ancestry), alpha = 0.3, size = 2) + theme_classic()
ggsave(filename = "/home/ziang/Documents/Stats-Gene/UKB/European_GWAS_hypertension_bp/figures/All_PC_Figure34.pdf", device = "pdf")
pheno_data_merged <- merge(pheno_data, PCi_want, by = "ID")
select_ID <- read.table("self_European_filtered_data.king.cutoff.in.id")
...
ggsave(filename = "/home/ziang/Documents/Stats-Gene/UKB/European_GWAS_hypertension_bp/figures/European_PC_cluster_Figure12.pdf", device = "pdf")
...
save(Cluster_Restrict_Data, file = "/home/ziang/Documents/Stats-Gene/UKB/European_GWAS_hypertension_bp/data/Cluster_Restrict_Data.rda")
...
ggsave(filename = "/home/ziang/Documents/Stats-Gene/UKB/European_GWAS_hypertension_bp/figures/European_PC_Figure12.pdf", device = "pdf")
...
ggsave(filename = "/home/ziang/Documents/Stats-Gene/UKB/European_GWAS_hypertension_bp/figures/European_PC_Figure13.pdf", device = "pdf")
...
ggsave(filename = "/home/ziang/Documents/Stats-Gene/UKB/European_GWAS_hypertension_bp/figures/European_PC_Figure23.pdf", device = "pdf")
Restrict_Data %>% ggplot() + geom_point(aes(x = PC3, y = PC4, color = Clusters), alpha = 0.3, size = 2) 
ggsave(filename = "/home/ziang/Documents/Stats-Gene/UKB/European_GWAS_hypertension_bp/figures/European_PC_Figure34.pdf", device = "pdf")
Restrict_Data %>% ggplot() + geom_point(aes(x = PC1, y = PC15, color = Clusters), alpha = 0.3, size = 2) 
ggsave(filename = "/home/ziang/Documents/Stats-Gene/UKB/European_GWAS_hypertension_bp/figures/European_PC_Figure115.pdf", device = "pdf")
...
#####################################################################
system(paste0(plink19,
              " --bfile ", "self_European_filtered_data",
              " --pca 20 header ",
              " --make-bed",
              " --out ", "self_European_PCA"))
newPCs <- read.table(file = "/home/ziang/Documents/Stats-Gene/UKB/European_GWAS_hypertension_bp/data/self_European_PCA.eigenvec", header = T)
...
ggsave(filename = "/home/ziang/Documents/Stats-Gene/UKB/European_GWAS_hypertension_bp/figures/European_newPC_Figure12.pdf", device = "pdf")
...
ggsave(filename = "/home/ziang/Documents/Stats-Gene/UKB/European_GWAS_hypertension_bp/figures/European_newPC_Figure13.pdf", device = "pdf")
...
ggsave(filename = "/home/ziang/Documents/Stats-Gene/UKB/European_GWAS_hypertension_bp/figures/European_newPC_Figure23.pdf", device = "pdf")
...
ggsave(filename = "/home/ziang/Documents/Stats-Gene/UKB/European_GWAS_hypertension_bp/figures/European_newPC_Figure34.pdf", device = "pdf")
...
save(final_data, file = "/home/ziang/Documents/Stats-Gene/UKB/European_GWAS_hypertension_bp/data/final_data.rda")

### Elbow Plot using new PCs:
newPC_eigenvec <- read.table(file = paste0(data_path, "self_European_PCA.eigenvec"), header = T)
newPC_eigen <- read.table(file = paste0(data_path, "self_European_PCA.eigenval"), header = F)
